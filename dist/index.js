...
const discourse = __importStar(__webpack_require__(920));
const format_1 = __webpack_require__(78);
const validations_1 = __webpack_require__(471);
...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const format = validations_1.validateFormat((_a = core.getInput('format')) !== null && _a !== void 0 ? _a : 'json');
            ...
            const results = yield discourse.executeQuery(hostname, id, params, discourseKey);
            switch (format) {
                case format_1.Format.JSON:
                    core.debug(`Write results to JSON file at ${path}`);
                    yield writeFile(path, JSON.stringify(results));
                    break;
                case format_1.Format.MARKDOWN:
                    core.debug(`Write results to Markdown file at ${path}`);
                    const table = yield discourse.resultsToTable(results);
                    yield writeFile(path, table);
                    break;
            }
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.validateFormat = exports.InvalidFormatError = void 0;
const format_1 = __webpack_require__(78);
/**
...
class InvalidFormatError extends Error {
    constructor(format) {
        super(`'${format}' is not a valid output format, please select one of: ${Object.values(format_1.Format).join(', ')}`);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.repeat = exports.resultsToTable = exports.executeQuery = void 0;
 ...
 */
function executeQuery(hostname, id, params, key) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.resultsToTable = resultsToTable;
function buildSeparator(count) {
    let separators = [];
...
function debugBlock(name, content) {
    core.debug(`===== ${name} =====`);
    core.debug(content);
